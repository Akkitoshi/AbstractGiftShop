...
namespace AbstractGiftShopServiceImplementDataBase.Implementations
{
    public class ImplementerServiceDB : IImplementerService
    {
        ...
        public ImplementerServiceDB(AbstractGiftShopDbContext context)
        {
        ...
        {
            var ordersImplementer = context.Implementers
                .Select(x => new
                {
                    ImplId = x.Id,
                ...
                .OrderBy(x => x.Count)
                .FirstOrDefault();
            if (ordersImplementer != null)
            {
                return GetElement(ordersImplementer.ImplId);
            }
            return null;
        }
    }
